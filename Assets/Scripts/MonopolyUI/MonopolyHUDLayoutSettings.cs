...
public class MonopolyHUDLayoutSettings : ScriptableObject
{
    ...
    public MonopolyUILayoutRect infoPanel = new MonopolyUILayoutRect(new Vector2(0f, 0f), new Vector2(0f, 0f), new Vector2(0f, 0f), new Vector2(48f, 48f), new Vector2(770f, 320f));
    ...
    public MonopolyUITextLayout infoText = new MonopolyUITextLayout("信息栏", 28, TextAnchor.UpperLeft, new MonopolyUIPadding(32, 32, 28, 28));
    ...
    public void ResetToDefaults()
    {
        ...
        infoPanel = new MonopolyUILayoutRect(new Vector2(0f, 0f), new Vector2(0f, 0f), new Vector2(0f, 0f), new Vector2(48f, 48f), new Vector2(770f, 320f));
        ...
        infoText = new MonopolyUITextLayout("信息栏", 28, TextAnchor.UpperLeft, new MonopolyUIPadding(32, 32, 28, 28));
